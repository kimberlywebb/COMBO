...
#'                                           Z = Z, n = n, n_cat = 2)
#' pitilde_by_chain_matrix <- pitilde_by_chain(n_chains = 2,
#'                                             chains_list = chains_list,
#'                                             V = V, n = n, n_cat = 2)
#' fixed_chains <- check_and_fix_chains_2stage(n_chains = 2, chains_list = chains_list,
#'                                             pistarjj_matrix = pistar_by_chain_matrix,
#'                                             pitildejjj_matrix = pitilde_by_chain_matrix,
#'                                             dim_x = ncol(X), dim_z = ncol(Z),
#'                                             dim_v = ncol(V),
#'                                             n_cat = 2)
#'
#' pistar_by_chain_matrix
#' pitilde_by_chain_matrix
#' chains_list[[1]][1:5,]
#' fixed_chains[[1]][1:5,]
#' chains_list[[2]][1:5,]
#' fixed_chains[[2]][1:5,]
